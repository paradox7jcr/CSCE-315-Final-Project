var MazeRunnerMap2 = function(game){
...
preload: function(){ 
		...
		this.game.load.audio('MazeRunnerSong2', 'assets/music/04_map2.mp3');
		...
		this.game.load.image('Exit', 'assets/buttons/ladder.png');
	},
	create: function() {
		game.scale.setGameSize(400,200);

		map2Music = game.add.audio('MazeRunnerSong2');
	  	map2Music.loopFull();
	  ...
	  //List of all tiles that the player collides with.
		map.setCollisionBetween(14, 19, true, 'main');
		map.setCollisionBetween(137,138, true, 'main');
		map.setCollisionBetween(462,464, true, 'main');
		map.setCollisionBetween(702,705, true, 'main');
		map.setCollisionBetween(732,735, true, 'main');
		map.setCollisionBetween(891,892, true, 'main');
	    ...
	    sprite = game.add.sprite(100, 500, 'person');
